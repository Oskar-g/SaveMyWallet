		...
		<div class="sidebar-inner slimscrollleft">
			...
			<div id="sidebar-menu">
				<ul>
					...
					<c:if test="${wallet.getId()>0}">
						<li><a href="statistics.html?wallet=${wallet.getId()}"
							class="waves-effect <c:if test="${menuSelect=='statistics'}">active</c:if>"><i
					...
					<li><a href="javascript:void(0);"
						...
						<ul class="list-unstyled">
							<li
								...
								<a href="#"
								onclick="alert('Esta funcionalidad aún no se ha implementado')">Agregar</a>
							</li>
							<li
								class="<c:if test="${subMenuSelect=='list_concept'}">active</c:if>">
								<a href="#"
								onclick="alert('Esta funcionalidad aún no se ha implementado')">Ver
									conceptos usados</a>
							</li>
						</ul></li>
